...
export default{
    setup()
    {
        ...
        return {page,pages,indicadores,getIndicadores}
    },
    components:{
        VPagination
    }
            ...
            <tbody>
                ...
                <tr class="bg-blue-500 border-b border-blue-400" v-for="(indicador, key ) in indicadores" :key="key">
                    ...
                    <th scope="row" class="px-6 py-4 font-medium text-blue-50 whitespace-nowrap dark:text-blue-100">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 float-left mr-1 cursor-pointer">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 float-left cursor-pointer">
